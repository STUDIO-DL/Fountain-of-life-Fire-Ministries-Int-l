...
const translations = {
    en: {
        ...
        conocenos: {
            ...
            section1Text: 'We are Fuente de Vida, Ministerio de Fuego, the church of Christ entrusted to preach salvation by demonstrating the power of God. We are not just a meeting place: we are a house where the Word is preached and the power of God is manifested to transform real lives.',
            ...
            section4Highlight: 'Anthony Ifesinachi',
        ...
        ramas: {
            ...
            heroText: 'Find a Fuente de Vida branch near you and join us in worship and spiritual growth.',
    ...
    fr: {
        ...
        conocenos: {
            ...
            section4Highlight: 'Anthony Ifesinachi',
            section4TextRest: 'Vous pouvez en savoir plus sur son ministère et sa parole quotidienne sur son compte Facebook officiel : Anthony Ifesinachi. Nous croyons en l’importance de la couverture spirituelle et de la paternité dans le ministère.',
            ...
            section7TextPart2: 'ou connectez-vous à la parole de notre père spirituel Anthony Ifesinachi sur Facebook.'
        },
        miembro: {
            heroTitle: 'Adhésion',
            heroText: 'Faites partie de notre famille de foi',
            welcomeTitle: 'Bienvenue à Source de Vie Ministère du Feu Int\'l',
